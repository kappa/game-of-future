...
- Start: Spawn a fresh default agent with the assigned player id, complete player profile, topic, research policy, session root, public file paths, private artifact path, and instruction not to inspect other teams.
